...
namespace NovaDebt
{
    public partial class AddEditTransactorForm : Form
    {
        private bool isEditable; // This field is the switch off between ADD and EDIT
        private int no;
        private string name;
        ...
        public AddEditTransactorForm(int no, string name, string since, string dueDate, string phoneNumber, string email, string facebook, decimal amount, string transactorType)
        {
            InitializeComponent();
